...
if($_SESSION['accountno']!='')
{
  ...
  $accountno=strtoupper($_SESSION['accountno']);
}
else
{
  $accountno =strtoupper($_SESSION['statusupdateaccno']);
}
                  ...
                  <div class="col-sm-6 col-xs-6 pl0">
                     ...
                     <div class="col-sm-6 col-xs-6 p0" id="firmdesc">
                        ...
                        <div class="col-sm-12 col-xs-12 p0"> <?php if($row['Place_of_Employment']==''){echo '--';}
                         ...
                         <a href="PlcmntEmp" target="_blank"><u><?php echo $row['Place_of_Employment'];?></u></a>
                         <?php } ?> </div>
            ...
            <div class="col-sm-12 col-xs-12">
               <div class="col-sm-6 col-xs-6 p0">
                  ...
                  <div class="col-sm-6 col-xs-6" id="currentstatusdesc">
                     ...
                     <div class="col-sm-12 col-xs-12 p0"> <a href="StatusUpdate" target="_blank">Click Here</a></div>
                     <!-- Settlement Form URL -->  
                     <div class="col-sm-12 col-xs-12 p0">
                              <?php 
         ...
         <div class="col-sm-4 col-xs-4 pr0">
               ...
               <div class="col-sm-3 col-xs-3 pr0" id="judgementdesc">
                  ...
                  <div class="col-sm-12 col-xs-12 p0"> <?php if($row['Judgment_Amount']=='$0.00'){echo $row['Judgment_Amount'];}
                    ...
                    <a href="jugBreakdown" target="_blank"><u><?php echo $row['Judgment_Amount'];?></u></a>
                    <?php } ?> </div>
               </div>
        </div>
...
spinner.show();
  ...
  $(document).ready(function(){
   ...
   if(id==1){
     window.open('combinedHist', '_blank');
   }
   if(id==2){
     window.open('postPlacement' , '_blank');
   }
   if(id==3){
     window.open('prePlacement' , '_blank');
   }
   if(id==4){
     window.open('statusDemo' , '_blank');
   }
  });
});
  $(document).ready(function(){
    $('#Documenationview').on('click', function() {
     ...
     var accNo='<?php echo $AccountNo;?>';
   if(id==1){
     window.open('PlcmntDocs', '_blank');
   }
   if(id==2){
     window.open('JudgmentDocs', '_blank');
   }
   if(id==3){
    window.open("/bi/dist/CLIENTGUIDE/ViewClientGuidesearchacc");
     //window.open("https://quay.aacanet.org/AACANet/members/PortfolioSearch.aspx?number=<?php echo base64_encode($row['RMSFILENUM']);?>");
   }
   if(id==4){
    window.open("Settlement_Form/settlement-request");
   ...
   $('#courtcost').on('click', function() {  
    ...
    if(id==1 && CourtCost >'$0.00'){
      window.open('FirmCost' , '_blank');
    }
     if(id==2 && CourtCost >'$0.00'){
      window.open('ClientCost', '_blank');
    }
    ...
    if(id==1 && recoveries >'$0.00'){
      window.open('FirmRecoveries', '_blank');
    }
     if(id==2 && recoveries >'$0.00'){
      window.open('ClientRecoveries' , '_blank');
    }
